        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            >
              ...
              <span className="block mt-2 text-gray-200">Rukhnuddin</span>
            </h2>
            ...
            <p
              ...
              data-aos-duration="1500"
            >
              I am a passionate software developer currently pursuing a Bachelor
              of Technology in Computer Science and Engineering at Sphoorthy
              Engineering College. I'm in my final year and love diving into
              modern technologies, solving real-world problems, and constantly
              learning new skills to build user-centric software experiences.
            </p>

            <div className="flex flex-col lg:flex-row items-center gap-4 lg:gap-4">
              <a
                href="https://github.com/Rukhnuddin786"
                target="_blank"
                rel="noreferrer"
              >
